...
if [[ $# -lt 1 ]]; then
    ...
    echo "ex. "
    echo "    bash makeNanoV9 <das_path> <name>"
    exit 1
fi
...
cmsDriver.py RECO --conditions 106X_dataRun2_v35 --customise Configuration/DataProcessing/Utils.addMonitoring \
    --datatier NANOAOD --era Run2_2016,run2_nanoAOD_106Xv2 --eventcontent NANOAOD \
