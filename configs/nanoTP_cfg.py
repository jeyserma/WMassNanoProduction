...
# with command line options: RECO --conditions 106X_mcRun2_asymptotic_v17 --datatier NANOAODSIM --eventcontent NANOAODSIM --era Run2_2016,run2_nanoAOD_106Xv2 --geometry DB:Extended --customise Configuration/DataProcessing/Utils.addMonitoring --filein file:72259A6D-F290-A049-9D65-182A9491D2DB.root --fileout file:nanoTP.root --nThreads 4 --no_exec --python_filename configs/nanoTP_cfg.py --mc --scenario pp --step PAT,USERNANO:nanotpSequenceMC --runUnscheduled -n 1000
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:72259A6D-F290-A049-9D65-182A9491D2DB.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:nanoTP.root'),
