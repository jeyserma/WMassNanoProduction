...
config.General.requestName = 'WplusJetsToMuNu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos_MCPostVFPWeightFix'
...
config.Data.outputDatasetTag = 'WplusJetsToMuNu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos_MCPostVFPWeightFix'
