...
config.General.requestName = 'WplusJetsToTauNu_TauToMu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos_MCPostVFPWeightFix'
...
config.Data.outputDatasetTag = 'WplusJetsToTauNu_TauToMu_TuneCP5_13TeV-powhegMiNNLO-pythia8-photos_MCPostVFPWeightFix'
